...
package org.cavvoh.settings.fragments.themes;
...
import org.cavvoh.settings.preferences.GlobalSettingListPreference;
import org.cavvoh.settings.utils.DeviceUtils;
import org.cavvoh.settings.utils.SystemUtils;
...
public class Themes extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.cavvoh_settings_themes);
        ...
        if (fingerprintManager == null || !fingerprintManager.isHardwareDetected()) {
            ...
            if (!Utils.isPackageInstalled(context, "org.cavvoh.udfps.icons")) {
                mIconsCategory.removePreference(mUdfpsIcon);
            }
            if (!Utils.isPackageInstalled(context, "org.cavvoh.udfps.animations")) {
                mAnimationsCategory.removePreference(mUdfpsAnimation);
            }
        }
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        new BaseSearchIndexProvider(R.xml.cavvoh_settings_themes) {
